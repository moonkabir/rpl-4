...
<div id="contents" class="sixteen columns">
                ...
                <h3>
                    <marquee direction="left" scrollamount="4" onmouseover="this.stop()"
                        ...
                        পৌঁছে দিন নির্বাচিত সরকারি-বেসরকারি প্রতিষ্ঠানসমূহে। ভিজিট করুন <a
                            ...
                            href="http://play.google.com/store/apps/details?id=com.synesis.donationapp"
                            target="_blank" style="color: blue;">“Ek Desh”</a> অ্যাপ ডাউনলোড করুন। করোনার লক্ষণ
            ...
            <div class="scroll">
                <h3>
                    <marquee direction="left" scrollamount="4" onmouseover="this.stop()"
                        ...
                        ল্যাপটপসহ ১৫০টি আকর্ষণীয় পুরস্কার। অংশ নিতে ভিজিট করুন: <a
                            href="https://bangladesh50.gov.bd/" style="color:blue">bangladesh50.gov.bd</a>
                    </marquee>
                </h3>
            </div>
                            ...
                            <div class="slider slider1">
                                ...
                                <div class="eservice-block">
                                    <div class="eservice-cat">
                                        <a href="#">
                                            <img src="sites/eservice_cat_icon/utility.png" alt="" width=""
                                                height="" /> </a>
            ...
            <ul class="popular-portal">
                <li>
                    <a target="_blank" href="http://forms.gov.bd/">
                        <img src="sites/popular_portal/forms_portal_logo%20(1).png" alt="" width="222"
                            height="65" /> </a>
                        ...
                        <div class="topservices" id="topservices">
                            <ul style="list-style-type:square">
                                ...
                                <li><a title="আয়কর" নিবন্ধন="" target="_blank"
                                        ...
                                        নিবন্ধন</a></li>
                                <li><a title="এসএসসি," দাখিল="" ও="" সমমানের="" পরীক্ষার="" ফলাফল=""
                                        target="_blank"
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align:center">
                                <p><iframe frameborder="0" height="200"
                                        src="https://www.youtube.com/embed/zBAKSZqTkRg" width="100%"></iframe>
                                </p>
                            ...
                            <td style="text-align:center">
                                <p><iframe frameborder="0" height="200"
                                        src="https://www.youtube.com/embed/GT9ShGE_qjg" width="100%"></iframe>
                                </p>
                            ...
                            <td style="text-align:center">
                                <p><iframe frameborder="0" height="200"
                                        src="https://www.youtube.com/embed/aI97ajpyq00"
    ...
    <div class="five columns ml10" id="right-content">
        ...
        <div class="nav_all_national_portal right-side-video">
            ...
            <iframe width="100%" height="220" src="https://www.youtube.com/embed/B0FgrYBE4uY?rel=0"
            ...
            <iframe width="100%" height="220"
                src="https://www.youtube.com/embed/QNUSIOMb6vI?showinfo=0&amp;rel=0" frameborder="0"
                allowfullscreen></iframe>
        </div>
        <ul class="graphical-service-btn">
            <li>
                <a target="_blank" href="https://mof.portal.gov.bd/site/view/budget_mof/২০১৯-২০/">
                    <img src="sites/graphical_service_button/budget_bn_new.png"
                        alt="" width="315" height="60" /> </a>

            </li>
            <li>
                <a target="_blank" href="http://www.dsebd.org/">
                    <img src="sites/graphical_service_button/stock_bangla.png"
                        alt="" width="315" height="60" /> </a>
